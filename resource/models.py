...
class InvalidStuff(models.Model):
    ...
    room = models.ForeignKey(Room, on_delete=models.CASCADE, verbose_name=_("Xona"))
    stuff = models.ForeignKey(Stuff, on_delete=models.CASCADE, null=True, verbose_name=_("Jihoz"))
...
class InvalidMedicine(models.Model):
    ...
    batch = models.ForeignKey(BatchMedicine, on_delete=models.CASCADE, verbose_name=_("Partiya"), null=True)
